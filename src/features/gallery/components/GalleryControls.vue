...
function handlePrevHover() {
  isHoveringPrev.value = true
  emit('preload-page', props.currentPage - 1)
}

function handleNextHover() {
  isHoveringNext.value = true
  emit('preload-page', props.currentPage + 1)
}
