...
const MOCK_IMAGE_1: PicsumImage = {
  id: '1', author: 'Author One', width: 100, height: 100, url: 'url1', download_url: 'download1',
};
const MOCK_IMAGE_2: PicsumImage = {
  id: '2', author: 'Author Two', width: 200, height: 200, url: 'url2', download_url: 'download2',
};
...
describe('imageStore', () => {
  ...
  describe('Action: fetchImageList', () => {
    ...
    it('handles failure: sets loading state, and populates the error field', async () => {
      ...
      (picsumService.fetchImageList as ReturnType<typeof vi.fn>).mockRejectedValue(new Error(errorMessage));
